/**
 * Custom instructions for LangDock
 * This file contains specific instructions for the LangDock AI platform
 */

// Export the custom instructions for LangDock
export const langdockInstructions = `
...
Example of a properly formatted tool call for LangDock:
