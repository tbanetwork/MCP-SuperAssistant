...
import { LangDockAdapter } from './langdockAdapter';
...
const adapterInfos: AdapterInfo[] = [
  ...
  { AdapterClass: LangDockAdapter, hostnames: ['app.langdock.com'] },
];
...
export const langdockAdapter = () => initializeAdapter(LangDockAdapter);
